		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div v-if="seller.supports" class="support">
					<span class="icon" :class="Eclass[seller.supports[0].type]"></span>
			...
			<div v-show="datailShow" class="detail">
				<div class="detail_content">
					...
					<ul v-if="seller.supports" class="supports">
						<li v-for="sellerd in seller.supports">
							<span class="icon" :class="Eclass[sellerd.type]"></span>
							<span class="text">{{sellerd.description}}</span>
						</li>
					</ul>
					<div class="title">
						<div class="line"></div>
