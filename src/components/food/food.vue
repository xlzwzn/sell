		...
		<div v-show="showFlag" class="food" ref="food">	
			<div>
				...
				<div class="rating">
					...
					<ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings" v-on:ratingtype-select="ratingtypeSelect" v-on:content-toggle="contentToggle"></ratingselect>
